...
class JumiaEnSpider(scrapy.Spider):
    ...
    def parse_data(self, response):
        ...
        l.add_xpath("picture2", "//div[@class='itm']/label[@for='imgs-sld-2']/img/@data-src")
        l.add_xpath("picture3", "//div[@class='itm']/label[@for='imgs-sld-3']/img/@data-src")
        # l.add_xpath("weight", "//div[@class='card-b -fh']/ul[@class='-pvs -mvxs -phm -lsn']//text()")
